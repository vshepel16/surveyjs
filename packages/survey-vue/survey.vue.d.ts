/*Type definitions for Survey JavaScript library vundefined
...
export declare class VueSurveyModel extends SurveyModel {
    static updatePropertiesHash(obj: any): void;
    renderCallback: () => void;
    render(): void;
...
export declare class MatrixTable extends Vue {
    ...
    readonly matrixDynamic: QuestionMatrixDynamicModel;
    readonly rows: MatrixDropdownRowModelBase[];
    readonly isColumnsHorizontal: boolean;
    readonly showHorizontalHeader: boolean;
    readonly showVerticalHeader: boolean;
...
export declare class JsonObjectProperty implements IObject {
    ...
    readOnly: boolean;
    isVisible(layout: string): boolean;
    visible: boolean;
